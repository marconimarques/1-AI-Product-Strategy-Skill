...
**User Pain:**
[Specific, quantified user problem if possible]
...
[Stage 1 -> Stage 2 -> Stage 3: how autonomy expands as trust is earned]
...
**Next (3 to 6 months):**
[Build on early validation - what comes after]

**Later (6 to 12 months):**
[Scale what works, instrument the feedback loops, expand the data moat]
...
|---|---|---|---|
| [Risk 1] | High/Med/Low | High/Med/Low | [What to do about it] |
| [Risk 2] | High/Med/Low | High/Med/Low | [What to do about it] |
